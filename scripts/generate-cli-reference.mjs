...
const commandPathParts = (command) => command.replace(/^neetoplaydash\s+/, "").split(/\s+/);
...
const groupToPage = {
  "neetoplaydash insights": "/cli-reference/insights",
  "neetoplaydash projects": "/cli-reference/projects",
  "neetoplaydash result-histories": "/cli-reference/result-histories",
  "neetoplaydash runs": "/cli-reference/runs",
  "neetoplaydash test-entities": "/cli-reference/test-entities",
  "neetoplaydash top-errors": "/cli-reference/top-errors",
  "neetoplaydash traces": "/cli-reference/traces",
};
...
const overviewSection = (group) => {
  ...
  const title = group.command.replace(/^neetoplaydash\s+/, "");
