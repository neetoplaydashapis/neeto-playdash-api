...
| Command | Description |
| --- | --- |
| [`neetoplaydash insights show`](/cli-reference/insights) | Show a project's daily and overall run and test insights |
...
| [`neetoplaydash runs show`](/cli-reference/runs) | Show a run with summary, statistics, and specs |
...
| [`neetoplaydash test-entities show`](/cli-reference/test-entities) | Show a test entity with outcomes and attempts |
